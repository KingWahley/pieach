    ...
    >
      ...
      <div className="relative z-20 mx-auto max-w-[1600px] w-full px-5 sm:px-8 lg:px-12 pt-24">
        <div className="max-w-4xl">
          <h1 className="projects-hero-el font-sans font-black text-4xl sm:text-6xl lg:text-7xl uppercase tracking-tighter leading-[1.05] text-white mb-6">
            Projects That Shape<br />Experiences
          </h1>
          <p className="projects-hero-el font-sans text-neutral-300 text-sm sm:text-base leading-relaxed font-light mb-8 max-w-xl">
            Browse our portfolio of residential, architectural, and master planning designs that define modern West Africa.
          </p>
          <div className="projects-hero-el flex flex-wrap items-center gap-4">
            <Link
              href="/contact"
