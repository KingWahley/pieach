...
export default function AboutHeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Background Image - GSAP translates it down to remain visually fixed */}
      <div 
        ref={bgRef}
      ...
      <div className="relative z-20 mx-auto max-w-[1600px] w-full px-5 sm:px-8 lg:px-12 pt-24">
        <div className="max-w-4xl">
          {/* Main Title */}
          <h1 className="about-hero-el font-sans font-black text-4xl sm:text-6xl lg:text-7xl uppercase tracking-tighter leading-[1.05] text-white mb-6">
            Designing Timeless <br className="hidden sm:inline" />
            Spaces Since 1997
          </h1>

          {/* Subtitle */}
          <p className="about-hero-el font-sans text-neutral-300 text-sm sm:text-base max-w-2xl mb-8 leading-relaxed font-light">
          ...
          {/* Buttons */}
          <div className="about-hero-el flex flex-wrap items-center gap-4">
            <Link
